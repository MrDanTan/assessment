package com.recruitment.avalog.repository;
...
@Repository
public interface DiceRollSimulationRepository extends JpaRepository<DiceRollSimulationEntity, Long>, JpaSpecificationExecutor<DiceRollSimulationEntity> {
